...
def main():
    ...
    data_train0 = data["data_train0"]
    data_train1 = data["data_train1"]
    data_test0 = data["data_test0"]
    data_test1 = data["data_test1"]

    model = BaselineNetwork().to(device)

    batch_size = 200  # Large batch_size seems to be important
    lr_enc = 5 * 10**-4
