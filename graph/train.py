...
def main():
    ...
    X_train_smaller, y_train_smaller = undersample_data(X_train, y_train, ratio=0.1)
    ...
    data_train0, data_train1 = split_based_on_class(data_train, y_train_smaller)
    data_test0, data_test1 = split_based_on_class(data_test, y_test)
